...
For decades now, food options in America have been primarily unhealthy. Unhealthy food options have grown from fast food industry to web-based delivery services. The convenience and the simplicity of ordering unhealthy food have been affecting dietary decisions of those who want to eat healthy. There are several ways to address this issue, one of which is to simply making their own food. For people who are motivated but inexperienced with cooking, the process of learning to prepare a home cooked meal must first be well understood. Most people today learn to cook by reading printed cookbooks, or following recipes online. However, most recipes are geared toward audience who have sufficient experience in cooking. A typical recipe lists out ingredients needed and either gives a paragraph describing what needs to be done, or a coarse list of steps that need to be carried out. 

To get a general sense of traditional recipe, we initially observed there subjects with varying cooking experience make a meal based on a recipe. Our preliminary observation showed that even experienced cooks exhibit difficulties in digesting the load of information that traditional recipe design presents, which lead to mistakes, frustrations, and even a loss in motivation to cook. One major cause of such effects is poor presentation of recipe. Consequently, the primary focus of this work is to improve the experience of learning a new recipe by improving the recipe design. Throughout the paper, we are primarily interested in answering the following questions: What is relevant and extraneous information in learning to cook? What format makes important information salient and reduces confusion? How will the difficulty of cooking be perceived as we design an interface that make important information salient and remove extraneous information?

For this work, we design a user interface for a machine assisted cooking application. The interface is iteratively improved based on series of detailed observations of novice chefs cooking. Our interface aims to maintain germane cognitive load and reduce extraneous load through effective recipe presentation. We focus on three main attributes to effective recipe presentation: instructions, ingredients, and materials. 
