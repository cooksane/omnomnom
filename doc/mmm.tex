...
The body of literature on cooking is similarly patchy. Recipe recommendation and generation are well documented in the literature [y, u, o]; many such systems have been built (e.g., gg) but do not assist users in making the recipe. Meanwhile, little or no research investigates the cognitive load of cooking, and few systems seek to address the possible overload. Kraftâ€™s iFood Assistant [q] and Quasar Computingâ€™s Cook Assistant Lite [j] seem to share our goals, but their design choices and user test results, if any, are not documented.
