...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"row instruction\">\n    <div class=\"col-lg-1 col-xs-1 list-number-control\">\n        <p>";
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "</p>\n            </div>\n        </div>\n        <button id=\"done\" type=\"button\" class=\"btn btn-lg btn-full-width\">Done</button>\n    </div>\n\n    <div id=\"mid\" class=\"col-lg-4\">\n        <div class=\"panel\">\n            <div class=\"panel-heading plain-panel-heading\">Ingredients</div>\n            <div id=\"ingredients-container\" class=\"panel-body plain-panel-body\">\n\n            </div>\n        </div>\n    </div>\n\n    <div id=\"right\" class=\"col-lg-6\">\n        <div class=\"panel\">\n            <div class=\"panel-heading plain-panel-heading text-center\">Instructions</div>\n            <div id=\"instruction-container\" class=\"panel-body plain-panel-body\">\n            </div>\n        </div>\n    </div>\n</div>\n";
  return buffer;
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "</p>\n            </div>\n        </div>\n        <button id=\"done\" type=\"button\" class=\"btn btn-lg btn-full-width\">Done</button>\n    </div>\n\n    <div id=\"mid\" class=\"col-lg-4\">\n        <div class=\"panel\">\n            <div class=\"panel-heading plain-panel-heading\">Ingredients</div>\n            <div id=\"ingredients-container\" class=\"panel-body plain-panel-body\">\n\n            </div>\n        </div>\n    </div>\n\n    <div id=\"right\" class=\"col-lg-6\">\n        <div class=\"panel\">\n            <div id=\"instruction-title\" class=\"panel-heading plain-panel-heading responsive-panel-header text-center\">Instructions</div>\n            <div id=\"instruction-container\" class=\"panel-body plain-panel-body invisible\">\n            </div>\n        </div>\n    </div>\n</div>\n";
  return buffer;
  });
