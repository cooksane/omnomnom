    ...
    function(CuratedModelBase, Utils) {
        ...
        var CuratedModel = CuratedModelBase.extend({
            ...
            instructions: [
                ...
                "Spread some of the sauce (from step 3) in the bottom of an 8 x 12 or 9 x 13 baking dish. (Ina recommends the former, I only had the latter; if you’d like to freeze or give this dish as a gift, remember to use a foil pan). Arrange a layer of noodles (from step 2) on top, then more sauce (about 1/4 of what remains), 1/3 of the mushrooms (from step 4) and 1/4 cup grated parmesan. Repeat two more times then top with a final layer of noodles, your remaining sauce and last 1/4 cup of parmesan.",
